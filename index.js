...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const premium = ["559887053394@s.whatsapp.net","559887572412@s.whatsapp.net","19734890640@s.whatsapp.net"] 
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'tts':
					...
					rano = getRandom('.ogg')
					dtt.length > 100
					? reply('A maior parte do texto é merda kkk')
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*𝙲𝚊𝚗𝚊𝚕 𝚍𝚘 𝚕𝚒𝚗𝚍𝚘 𝙲𝚊𝚞𝚜𝚜:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g\nTa ae o canal desse goxtoso kkk'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
